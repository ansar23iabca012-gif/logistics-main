import { Building2, Users, Clock, Shield, Phone, Mail, MapPin } from 'lucide-react';
...
export default function OfficeRelocationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(`Office Relocation Request Submitted!\n\nContact: ${formData.name}\nCompany: ${formData.companyName}\nEmail: ${formData.email}\nPhone: ${formData.phone}\nFrom: ${formData.fromLocation}\nTo: ${formData.toLocation}\n\nWe'll contact you shortly!`);
  ...
  return (
    <div className="bg-[#f5f1e8] min-h-screen">
      ...
      <div className="bg-gradient-to-r from-[#1a2545] to-[#2a3555] text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-5xl font-bold">Office Relocation Services</h1>
          </div>
          <p className="text-xl text-white/80 max-w-3xl">
            Seamless corporate relocation with minimal downtime. We ensure your business operations continue smoothly.
          </p>
        </div>
      </div>
      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#1a2545] mb-12 text-center">Why Choose Our Office Relocation Service?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-[#f5f1e8] rounded-xl hover:shadow-lg transition">
              ...
              <h3 className="text-xl font-bold text-[#1a2545] mb-3">Minimal Downtime</h3>
              <p className="text-gray-600">Strategic planning to minimize business interruption during the move</p>
            </div>
            <div className="text-center p-6 bg-[#f5f1e8] rounded-xl hover:shadow-lg transition">
              <div className="bg-gradient-to-br from-[#4a5fc1] to-[#8b5cf6] w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Users className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-xl font-bold text-[#1a2545] mb-3">Dedicated Team</h3>
              <p className="text-gray-600">Expert team specialized in corporate relocations</p>
            </div>
            <div className="text-center p-6 bg-[#f5f1e8] rounded-xl hover:shadow-lg transition">
              <div className="bg-gradient-to-br from-[#4a5fc1] to-[#8b5cf6] w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Shield className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-xl font-bold text-[#1a2545] mb-3">Secure Handling</h3>
              <p className="text-gray-600">Safe handling of sensitive equipment and documents</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
            <div className="bg-gradient-to-r from-[#1a2545] to-[#2a3555] text-white p-8">
              <h2 className="text-3xl font-bold mb-2">Request Office Relocation Service</h2>
              <p className="text-white/80">Fill out the form below and our corporate relocation team will contact you</p>
            </div>
            <form onSubmit={handleSubmit} className="p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-semibold text-[#1a2545] mb-2">Contact Person Name *</label>
                  <input
                    type="text"
                    name="name"
                    value={formData.name}
                ...
                <div>
                  <label className="block text-sm font-semibold text-[#1a2545] mb-2">Office Size *</label>
                  <select
                    name="officeSize"
                  ...
                  >
                    ...
                    <option value="Small (Up to 2000 sq ft)">Small (Up to 2000 sq ft)</option>
                    <option value="Medium (2000-5000 sq ft)">Medium (2000-5000 sq ft)</option>
                    <option value="Large (5000-10000 sq ft)">Large (5000-10000 sq ft)</option>
                    <option value="Very Large (10000+ sq ft)">Very Large (10000+ sq ft)</option>
                  </select>
                </div>
                <div className="md:col-span-2">
                  <label className="block text-sm font-semibold text-[#1a2545] mb-2">Number of Employees *</label>
                  <input
                    type="number"
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    placeholder="Special equipment, IT infrastructure, or any specific requirements..."
                  />
                </div>
              </div>
